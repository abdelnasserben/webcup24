                ...
                <div class="card-body p-lg-17">
                    ...
                    <div class="mb-18">
                        ...
                        <div class="mb-10">
                            ...
                            <div class="overlay">
                                <!--begin::Image-->
                                <img class="w-100 card-rounded" src="https://preview.keenthemes.com/ceres-html-pro/assets/media/stock/1600x800/img-1.jpg" alt="" />
                                <!--end::Image-->
                                <!--begin::Links-->
                        ...
                        <div class="row g-10">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card-xl-stretch me-md-6">
                                    ...
                                    <a class="d-block overlay mb-4" data-fslightbox="lightbox-hot-sales" href="assets/media/stock/600x400/img-73.jpg">
                                        <!--begin::Image-->
                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px" style="background-image:url('https://preview.keenthemes.com/ceres-html-pro/assets/media/stock/600x400/img-73.jpg')"></div>
                                        <!--end::Image-->
                                        <!--begin::Action-->
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card-xl-stretch mx-md-3">
                                    <!--begin::Overlay-->
                                    <a class="d-block overlay mb-4" data-fslightbox="lightbox-hot-sales" href="https://preview.keenthemes.com/ceres-html-pro/assets/media/stock/600x400/img-74.jpg">
                                        <!--begin::Image-->
                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px" style="background-image:url('https://preview.keenthemes.com/ceres-html-pro/assets/media/stock/600x400/img-74.jpg')"></div>
                                        <!--end::Image-->
                                        <!--begin::Action-->
                                        <div class="overlay-layer bg-dark card-rounded bg-opacity-25">
                                            <i class="bi bi-eye-fill fs-2x text-white"></i>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card-xl-stretch ms-md-6">
                                    <!--begin::Overlay-->
                                    <a class="d-block overlay mb-4" data-fslightbox="lightbox-hot-sales" href="https://preview.keenthemes.com/ceres-html-pro/assets/media/stock/600x400/img-47.jpg">
                                        <!--begin::Image-->
                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px" style="background-image:url('https://preview.keenthemes.com/ceres-html-pro/assets/media/stock/600x400/img-47.jpg')"></div>
                                        <!--end::Image-->
                                        <!--begin::Action-->
                                        <div class="overlay-layer bg-dark card-rounded bg-opacity-25">
                                            <i class="bi bi-eye-fill fs-2x text-white"></i>
                    ...
                    <div class="mb-18">
                        ...
                        <div class="tns tns-default mb-10">
                            ...
                            <div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false" data-tns-speed="2000" data-tns-autoplay="true" data-tns-autoplay-timeout="18000" data-tns-controls="true" data-tns-nav="false" data-tns-items="1" data-tns-center="false" data-tns-dots="false" data-tns-prev-button="#kt_team_slider_prev" data-tns-next-button="#kt_team_slider_next" data-tns-responsive="{1200: {items: 3}, 992: {items: 2}}">
                                ...
                                <div class="text-center">
                                    <!--begin::Photo-->
                                    <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style='background-image:url("{{ asset('assets/avatars/150-1.jpg')}}")'></div>
                                    <!--end::Photo-->
                                    <!--begin::Person-->
                                    <div class="mb-0">
                                        <!--begin::Name-->
                                ...
                                <div class="text-center">
                                    <!--begin::Photo-->
                                    <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style='background-image:url("{{ asset('assets/avatars/150-3.jpg')}}")'></div>
                                    <!--end::Photo-->
                                    <!--begin::Person-->
                                    <div class="mb-0">
                                        <!--begin::Name-->
                                ...
                                <div class="text-center">
                                    <!--begin::Photo-->
                                    <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style='background-image:url("{{ asset('assets/avatars/150-4.jpg')}}")'></div>
                                    <!--end::Photo-->
                                    <!--begin::Person-->
                                    <div class="mb-0">
                                        <!--begin::Name-->
                                ...
                                <div class="text-center">
                                    <!--begin::Photo-->
                                    <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style='background-image:url("{{ asset('assets/avatars/150-5.jpg')}}")'></div>
                                    <!--end::Photo-->
                                    <!--begin::Person-->
                                    <div class="mb-0">
                                        <!--begin::Name-->
                                ...
                                <div class="text-center">
                                    <!--begin::Photo-->
                                    <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style='background-image:url("{{ asset('assets/avatars/150-6.jpg')}}")'></div>
                                    <!--end::Photo-->
                                    <!--begin::Person-->
                                    <div class="mb-0">
                                        <!--begin::Name-->
                                ...
                                <div class="text-center">
                                    <!--begin::Photo-->
                                    <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style='background-image:url("{{ asset('assets/avatars/150-7.jpg')}}")'></div>
                                    <!--end::Photo-->
                                    <!--begin::Person-->
                                    <div class="mb-0">
                                        <!--begin::Name-->
                                ...
                                <div class="text-center">
                                    <!--begin::Photo-->
                                    <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center" style='background-image:url("{{ asset('assets/avatars/150-8.jpg')}}")'></div>
                                    <!--end::Photo-->
                                    <!--begin::Person-->
                                    <div class="mb-0">
                                        <!--begin::Name-->
                    ...
                    <div class="card bg-light text-center">
                        ...
                        <div class="card-body py-12">
                            <!--begin::Icon-->
                            <a href="#" class="mx-4">
                                <img src="{{ asset('assets/brand-logos/facebook-4.svg')}}" class="h-30px my-2" alt="" />
                            </a>
                            <!--end::Icon-->
                            <!--begin::Icon-->
                            <a href="#" class="mx-4">
                                <img src="{{ asset('assets/brand-logos/instagram-2-1.svg')}}" class="h-30px my-2" alt="" />
                            </a>
                            <!--end::Icon-->
                            <!--begin::Icon-->
                            <a href="#" class="mx-4">
                                <img src="{{ asset('assets/brand-logos/github.svg')}}" class="h-30px my-2" alt="" />
                            </a>
                            <!--end::Icon-->
                            <!--begin::Icon-->
                            <a href="#" class="mx-4">
                                <img src="{{ asset('assets/brand-logos/behance.svg')}}" class="h-30px my-2" alt="" />
                            </a>
                            <!--end::Icon-->
                            <!--begin::Icon-->
                            <a href="#" class="mx-4">
                                <img src="{{ asset('assets/brand-logos/pinterest-p.svg')}}" class="h-30px my-2" alt="" />
                            </a>
                            <!--end::Icon-->
                            <!--begin::Icon-->
                            <a href="#" class="mx-4">
                                <img src="{{ asset('assets/brand-logos/twitter.svg')}}" class="h-30px my-2" alt="" />
                            </a>
                            <!--end::Icon-->
                            <!--begin::Icon-->
                            <a href="#" class="mx-4">
                                <img src="{{ asset('assets/brand-logos/dribbble-icon-1.svg')}}" class="h-30px my-2" alt="" />
                            </a>
                            <!--end::Icon-->
                        </div>
                        <!--end::Body-->

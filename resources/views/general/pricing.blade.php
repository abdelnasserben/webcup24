                            ...
                            <tr id="kt_pricing">
                                ...
                                <th class="text-center min-w-200px">
                                    <div class="min-w-200px mb-15">
                                        ...
                                        <a href="#"
                                            class="btn btn-light-primary fw-bold mx-auto">Start</a>
                                    </div>
                                </th>
                                ...
                                <th class="text-center min-w-200px">
                                    <div class="min-w-200px mb-15">
                                        ...
                                        <div
                                            class="fs-5x d-flex justify-content-center align-items-start">
                                            <span class="fs-2 mt-3">$</span>
                                        ...
                                        <a href="#"
                                            class="btn btn-light-primary fw-bold mx-auto">Select</a>
                                    </div>
                                </th>
                            </tr>
                        </thead>
                        ...
                        <tbody>
                            <tr>
                                <th class="card-rounded-start">
                                    <div class="fw-bold d-flex align-items-center ps-9 fs-3">Sublicense
                                        Visuals</div>
                                </th>
                                ...
                                <td>
                                    <div class="flex-root d-flex justify-content-center">
                                        ...
                                        <span class="h-40px w-40px d-flex flex-center d-none">
                                            <i class="ki-duotone ki-cross fs-2x text-0"><span
                            ...
                            <tr>
                                <th class="card-rounded-start">
                                    <div class="fw-bold d-flex align-items-center ps-9 fs-3">Free
                                        Updates</div>
                                </th>
                            ...
                            <tr>
                                <th class="card-rounded-start">
                                    <div class="fw-bold d-flex align-items-center ps-9 fs-3">Theme
                                        Support</div>
                                </th>
                            ...
                            <tr>
                                <th class="card-rounded-start">
                                    <div class="fw-bold d-flex align-items-center ps-9 fs-3">Unlimited
                                        Websites</div>
                                </th>
                            ...
                            <tr>
                                <th class="card-rounded-start">
                                    <div class="fw-bold d-flex align-items-center ps-9 fs-3">DDOS
                                        Protection</div>
                                </th>
                            ...
                            <tr>
                                <th class="card-rounded-start">
                                    <div class="fw-bold d-flex align-items-center ps-9 fs-3">Domain
                                        Reseller</div>
                                </th>

                    ...
                    <div class="col-md-6 pe-md-10 mb-10 mb-md-0">
                        ...
                        <div class="m-0">
                            ...
                            <div class="d-flex align-items-center collapsible py-3 toggle collapsed mb-0" data-bs-toggle="collapse" data-bs-target="#kt_job_4_2">
                                ...
                                <!--end::Icon-->
                                <!--begin::Title-->
                                <h4 class="text-gray-700 fw-bolder cursor-pointer mb-0">Do I need a designer to use Rider?</h4>
                                <!--end::Title-->
                            </div>
                            <!--end::Heading-->
                            <!--begin::Body-->
                    ...
                    <div class="row g-10">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card-xl-stretch me-md-6">
                                <!--begin::Overlay-->
                                <a class="d-block overlay mb-4" data-fslightbox="lightbox-hot-sales" href="{{ asset('assets/faq/img-1.jpg')}}">
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px" style='background-image:url("{{ asset('assets/faq/img-1.jpg')}}")'></div>
                                    <!--end::Image-->
                                    <!--begin::Action-->
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card-xl-stretch mx-md-3">
                                <!--begin::Overlay-->
                                <a class="d-block overlay mb-4" data-fslightbox="lightbox-hot-sales" href="{{ asset('assets/faq/img-2.jpg')}}">
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px" style='background-image:url("{{ asset('assets/faq/img-2.jpg')}}")'></div>
                                    <!--end::Image-->
                                    <!--begin::Action-->
                                    <div class="overlay-layer bg-dark card-rounded bg-opacity-25">
                                        <i class="bi bi-eye-fill fs-2x text-white"></i>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card-xl-stretch ms-md-6">
                                <!--begin::Overlay-->
                                <a class="d-block overlay mb-4" data-fslightbox="lightbox-hot-sales" href="{{ asset('assets/faq/img-3.jpg')}}">
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px" style='background-image:url("{{ asset('assets/faq/img-3.jpg')}}")'></div>
                                    <!--end::Image-->
                                    <!--begin::Action-->
                                    <div class="overlay-layer bg-dark card-rounded bg-opacity-25">
                                        <i class="bi bi-eye-fill fs-2x text-white"></i>
